...
<div class="darkmodeswitchwrapper">
		<input <?php echo $checked ?> type="checkbox" id="darkmodeswitchIbn_E_Salah"/>
		<label for="darkmodeswitchIbn_E_Salah">
...
.darkmodeswitchwrapper label:after {
	content: "";
	width:30px;
	height: 30px;
	position: absolute;
...
.darkmodeswitchwrapper input {
	width: 0;
	height: 0;
	visibility: hidden;
}
.darkmodeswitchwrapper input:checked + label {
	background: #242424;
}
.darkmodeswitchwrapper input:checked + label:after {
	left:81px;
	transform: translateX(-100%);
	background: linear-gradient(180deg,#777,#3a3a3a);
}
.darkmodeswitchwrapper label:active:after{
	width: 43px;
}

.darkmodeswitchwrapper input:checked + label + .background {
	background:#242424;
}
.darkmodeswitchwrapper label svg {
	position: absolute;
	width: 20px;
	top:6.66px;
	z-index: 100;
